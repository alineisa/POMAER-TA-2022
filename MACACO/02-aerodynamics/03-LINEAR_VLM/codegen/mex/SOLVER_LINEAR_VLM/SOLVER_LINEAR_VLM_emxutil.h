/*
 * SOLVER_LINEAR_VLM_emxutil.h
 *
 * Code generation for function 'SOLVER_LINEAR_VLM_emxutil'
 *
 */

#ifndef SOLVER_LINEAR_VLM_EMXUTIL_H
#define SOLVER_LINEAR_VLM_EMXUTIL_H
...
/* End of code generation (SOLVER_LINEAR_VLM_emxutil.h) */
