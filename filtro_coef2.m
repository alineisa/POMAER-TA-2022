function [penal] = filtro_coef2(vlm_bruto)
% Filtro de valores NaN e diverg�ncias
...
%         disp('Foi encontrado um outlier. Continue rodando, mas sugiro avisar o aerodinamicista mais proximo!');
